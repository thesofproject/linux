 ...
 * @get_max_bufsize:	see @rpmsg_get_max_bufsize(), optional
...
struct rpmsg_endpoint_ops {
	...
	int (*get_max_bufsize)(struct rpmsg_endpoint *ept);
	...
	int (*sendto_nocopy)(struct rpmsg_endpoint *ept,
			     void *data, int len, u32 dst);
	int (*send_offchannel_nocopy)(struct rpmsg_endpoint *ept,
