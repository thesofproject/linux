...
static int virtio_rpmsg_send_nocopy(struct rpmsg_endpoint *ept,
				    void *data, int len);
static int virtio_rpmsg_sendto_nocopy(struct rpmsg_endpoint *ept,
				      void *data, int len, u32 dst);
static int virtio_rpmsg_send_offchannel_nocopy(struct rpmsg_endpoint *ept,
					       u32 src, u32 dst,
					       void *data, int len);
...
static int virtio_rpmsg_send_nocopy(struct rpmsg_endpoint *ept,
				    void *data, int len)
{
	return rpmsg_send_offchannel_nocopy(ept,
		ept->addr, ept->rpdev->dst, data, len);
}
...
static int virtio_rpmsg_send(struct rpmsg_endpoint *ept, void *data, int len)
{
	return rpmsg_send_offchannel(ept,
		ept->addr, ept->rpdev->dst, data, len);
}
...
static int virtio_rpmsg_trysend(struct rpmsg_endpoint *ept, void *data, int len)
{
	return rpmsg_trysend_offchannel(ept,
		ept->addr, ept->rpdev->dst, data, len);
}
