...
/*
 * Normally defined in cros_ec_commands.h. To be able to compile as
 * a GKI proprietary module, no changes to API (including
 * cros_ec_commands.h) are allowed.
 */
#define MOTIONSENSE_TYPE_LIGHT_RGB 8
