...
/*
 * snd_soc_component needs device to operate on (primarly for prints), create
...
int d_probe(struct snd_soc_component *component)
{
...
void d_remove(struct snd_soc_component *component)
{
	struct kunit_soc_component *kunit_comp =
			container_of(component, struct kunit_soc_component, comp);
	int ret;
...
struct tplg_tmpl_002 tplg_tmpl_with_pcm = {
	.header = {
		.magic = SND_SOC_TPLG_MAGIC,
		.abi = 5,
		.version = 0,
 ...
 */
int d_probe_null_comp(struct snd_soc_component *component)
{
	struct kunit_soc_component *kunit_comp =
			container_of(component, struct kunit_soc_component, comp);
	int ret;
 ...
 */
int d_probe_null_fw(struct snd_soc_component *component)
{
	struct kunit_soc_component *kunit_comp =
			container_of(component, struct kunit_soc_component, comp);
	int ret;
