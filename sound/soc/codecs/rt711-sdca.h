...
/*
 * rt711-sdca.h -- RT711 ALSA SoC audio driver header
 *
...
#define RT711_SDCA_CTL(fun, ent, ctl, ch) (BIT(30) |	\
					    (((fun) & 0x7) << 22) |	\
					    (((ent) & 0x40) << 15) |	\
					    (((ent) & 0x3f) << 7) |	\
					    (((ctl) & 0x30) << 15) |	\
...
/* SDCA entity */
#define ENT_HID01 0x01
#define ENT_GE49 0x49
#define ENT_USER_FU05 0x05
#define ENT_USER_FU0F 0x0f
#define ENT_USER_FU1E 0x1e
#define ENT_PLATFORM_FU15 0x15
#define ENT_PLATFORM_FU44 0x44
#define ENT_PDE28 0x28
#define ENT_PDE29 0x29
#define ENT_PDE2A 0x2a
#define ENT_CS01 0x01
#define ENT_CS11 0x11
#define ENT_CS1F 0x1f
#define ENT_OT1 0x06
...
#define CTL_FU_CH_GAIN 0x0b
#define CTL_FU_MUTE 0x01
#define CTL_FU_VOLUME 0x02
#define CTL_HIDTX_CURRENT_OWNER 0x10
#define CTL_HIDTX_SET_OWNER_TO_DEVICE 0x11
#define CTL_HIDTX_MESSAGE_OFFSET 0x12
#define CTL_SELECTED_MODE 0x01
#define CTL_DETECTED_MODE 0x02
#define CTL_REQ_POWER_STATE 0x01
#define CTL_VENDOR_DEF 0x30
...
int rt711_sdca_jack_detect(struct rt711_priv *rt711, bool *hp, bool *mic);
