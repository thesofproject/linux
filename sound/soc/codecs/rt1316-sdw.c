...
//
// rt1316-sdw.c -- rt1316 ALSA SoC amplifier audio driver
//
...
static bool rt1316_readable_register(struct device *dev, unsigned int reg)
{
	...
	case 0xcf00 ... 0xcf03:
	case 0xd101 ... 0xd103:
	case RT1316_SDCA_CTL(FUN_SMART_AMP, ENT_UDMPU21,
		CTL_UDMPU_CLUSTER, 0x0):
	case RT1316_SDCA_CTL(FUN_SMART_AMP, ENT_FU21, CTL_FU_MUTE, CH_L):
	case RT1316_SDCA_CTL(FUN_SMART_AMP, ENT_FU21, CTL_FU_MUTE, CH_R):
	case RT1316_SDCA_CTL(FUN_SMART_AMP, ENT_PDE23, CTL_REQ_POWER_STATE, 0):
	case RT1316_SDCA_CTL(FUN_SMART_AMP, ENT_PDE27, CTL_REQ_POWER_STATE, 0):
	case RT1316_SDCA_CTL(FUN_SMART_AMP, ENT_PDE22, CTL_REQ_POWER_STATE, 0):
	case RT1316_SDCA_CTL(FUN_SMART_AMP, ENT_PDE24, CTL_REQ_POWER_STATE, 0):
		return true;
	default:
		return false;
	}
...
static int rt1316_io_init(struct device *dev, struct sdw_slave *slave)
{
	...
	regmap_write(rt1316->regmap,
		RT1316_SDCA_CTL(FUN_SMART_AMP, ENT_XU24, CTL_BYPASS, 0), 0x00);
	...
	struct snd_kcontrol *kcontrol, int event)
{
	...
	case SND_SOC_DAPM_POST_PMU:
		snd_soc_component_write(component,
			RT1316_SDCA_CTL(FUN_SMART_AMP, ENT_PDE23,
			CTL_REQ_POWER_STATE, 0), PS0);
		snd_soc_component_write(component,
			RT1316_SDCA_CTL(FUN_SMART_AMP, ENT_PDE27,
			CTL_REQ_POWER_STATE, 0), PS0);
		snd_soc_component_write(component,
			RT1316_SDCA_CTL(FUN_SMART_AMP, ENT_PDE22,
			CTL_REQ_POWER_STATE, 0), PS0);
		break;
	...
	struct snd_kcontrol *kcontrol, int event)
{
	...
	case SND_SOC_DAPM_POST_PMU:
		snd_soc_component_write(component,
			RT1316_SDCA_CTL(FUN_SMART_AMP, ENT_PDE24,
			CTL_REQ_POWER_STATE, 0), PS0);
		break;
	case SND_SOC_DAPM_PRE_PMD:
		snd_soc_component_write(component,
...
static SOC_ENUM_SINGLE_DECL(rt1316_rx_data_ch_enum,
	RT1316_SDCA_CTL(FUN_SMART_AMP, ENT_UDMPU21, CTL_UDMPU_CLUSTER, 0), 0,
...
static SOC_ENUM_SINGLE_DECL(rt1316_xu24_bypass_enum,
	RT1316_SDCA_CTL(FUN_SMART_AMP, ENT_XU24, CTL_BYPASS, 0), 0,
...
static const struct snd_kcontrol_new rt1316_sto_dac_l =
	SOC_DAPM_SINGLE_AUTODISABLE("Switch",
		RT1316_SDCA_CTL(FUN_SMART_AMP, ENT_FU21, CTL_FU_MUTE, CH_L),
		0, 1, 1);

static const struct snd_kcontrol_new rt1316_sto_dac_r =
	SOC_DAPM_SINGLE_AUTODISABLE("Switch",
		RT1316_SDCA_CTL(FUN_SMART_AMP, ENT_FU21, CTL_FU_MUTE, CH_R),
		0, 1, 1);
