...
EXPORT_SYMBOL_NS(asoc_sdw_get_codec_info_list_size, SND_SOC_SDW_UTILS);
...
EXPORT_SYMBOL_NS(asoc_sdw_get_codec_dai_by_name, SND_SOC_SDW_UTILS);
...
EXPORT_SYMBOL_NS(asoc_sdw_is_unique_device, SND_SOC_SDW_UTILS);
...
void asoc_sdw_mc_dailink_exit_loop(struct snd_soc_card *card)
{
	...
	int ret;
	int i, j;
	int codec_info_list_size = asoc_sdw_get_codec_info_list_size();
