...
#define SDW_PART_ID_MAX98363 0x8363
#define SDW_PART_ID_MAX98373 0x8373
...
static int asoc_sdw_mx8373_sdw_prepare(struct snd_pcm_substream *substream)
{
	int ret;
...
static int asoc_sdw_mx8373_sdw_hw_free(struct snd_pcm_substream *substream)
{
	int ret;
...
static const struct snd_soc_ops max_98373_sdw_ops = {
	...
	.prepare = asoc_sdw_mx8373_sdw_prepare,
	.trigger = asoc_sdw_trigger,
	.hw_params = asoc_sdw_hw_params,
	.hw_free = asoc_sdw_mx8373_sdw_hw_free,
