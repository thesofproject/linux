...
struct snd_soc_dai *asoc_sdw_get_codec_dai_by_name(struct snd_soc_pcm_runtime *rtd,
...
int asoc_sdw_rt_amp_spk_rtd_init(struct snd_soc_pcm_runtime *rtd);
int asoc_sdw_rt_sdca_jack_rtd_init(struct snd_soc_pcm_runtime *rtd);
int asoc_sdw_cs42l42_rtd_init(struct snd_soc_pcm_runtime *rtd);
int asoc_sdw_cs42l43_hs_rtd_init(struct snd_soc_pcm_runtime *rtd);
int asoc_sdw_cs42l43_spk_rtd_init(struct snd_soc_pcm_runtime *rtd);
int asoc_sdw_cs42l43_dmic_rtd_init(struct snd_soc_pcm_runtime *rtd);
int asoc_sdw_cs_spk_rtd_init(struct snd_soc_pcm_runtime *rtd);
int asoc_sdw_maxim_spk_rtd_init(struct snd_soc_pcm_runtime *rtd);
