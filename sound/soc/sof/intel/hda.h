...
#define HDA_DSP_SRAM_REG_FW_IPC_RECEIVED_COUNT	(HDA_DSP_MBOX_OFFSET + 0xc)
#define HDA_DSP_SRAM_REG_FW_IPC_PROCESSED_COUNT	(HDA_DSP_MBOX_OFFSET + 0x10)
#define HDA_DSP_SRAM_REG_FW_END			(HDA_DSP_MBOX_OFFSET + 0x14)
