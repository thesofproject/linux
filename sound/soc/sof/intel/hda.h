...
#define HDA_DSP_HDA_BAR				SOF_BAR_TYPE_HDA
#define HDA_DSP_PP_BAR				SOF_BAR_TYPE_PP
#define HDA_DSP_SPIB_BAR			SOF_BAR_TYPE_SPIB
#define HDA_DSP_DRSM_BAR			SOF_BAR_TYPE_DRSM
#define HDA_DSP_BAR				SOF_FW_BAR_TYPE_DRAM
