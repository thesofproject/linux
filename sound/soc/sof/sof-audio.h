...
struct snd_sof_widget {
	...
	int pipeline_id;
	/*
	 * complete is used to indicate that pipeline set up is complete for scheduler type
	 * widgets. For all other types of widgets, it is used to indicate that the widget has
	 * been prepared for getting set up in the DSP.
	 */
	int complete;
