...
/**
 * sof_ipc_prepare_send_msg - generic function to prepare and send one IPC message
 ...
 */
int sof_ipc_prepare_send_msg(struct snd_sof_dev *sdev,
			     void *msg_data, size_t msg_bytes, size_t reply_bytes)
{
...
struct snd_sof_ipc *snd_sof_ipc_init(struct snd_sof_dev *sdev)
{
	...
	if (!ipc->ops->tx_msg || !ipc->ops->set_get_data || !ipc->ops->pcm ||
	    !ipc->ops->tplg || !ipc->ops->tplg->widget || !ipc->ops->tplg->control) {
